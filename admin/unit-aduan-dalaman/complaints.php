<?php
/**
 * Unit Aduan Dalaman - Complaints List
 */
...
<head>
    ...
    <title>Senarai Aduan - Unit Aduan Dalaman</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            <form method="GET" class="flex flex-wrap gap-4">
                ...
                <div>
                    <select name="workflow_status" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">
                        <option value="all" <?php echo $workflow_filter === 'all' ? 'selected' : ''; ?>>Semua Status</option>
                        <option value="baru" <?php echo $workflow_filter === 'baru' ? 'selected' : ''; ?>>Baru</option>
                        <option value="disahkan_unit_aduan" <?php echo $workflow_filter === 'disahkan_unit_aduan' ? 'selected' : ''; ?>>Disahkan Unit Aduan</option>
                        <option value="dimajukan_unit_aset" <?php echo $workflow_filter === 'dimajukan_unit_aset' ? 'selected' : ''; ?>>Dimajukan ke Unit Aset</option>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b-2 border-gray-200">
                            ...
                            <th class="text-left py-3 px-4 font-semibold text-gray-700">Status Workflow</th>
                            ...
                            <tr class="border-b border-gray-100 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4">
                                    <a href="view_complaint.php?id=<?php echo $complaint['id']; ?>"
                                       class="text-purple-600 hover:text-purple-800 mr-3" title="Lihat & Proses">
